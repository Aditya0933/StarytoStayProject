    ...
    return(
        <div className="relative">
            ...
            <div className="flex flex-col justify-center  py-20 px-10 text-black">
                ...
                <p className="text-center mt-4 text-white z-50">We are non-profit organization devoted to fastening discarded and homeless pets with the goal of re-homing them to their home forever.</p>
            </div>
        </div>
    )
}